...
```{r}
modelo_fh2_spatial_new_edu <- inla(
...
model_metrics <- tibble(
  ...
  DIC     = c(modelo_fh10_spatial_edu$dic$dic, modelo_fh8_spatial_edu$dic$dic, 
              modelo_fh5_spatial_edu$dic$dic, modelo_fh2_spatial_edu$dic$dic,modelo_fh2_spatial_new_edu$dic$dic),
  pD      = c(modelo_fh10_spatial_edu$dic$p.eff, modelo_fh8_spatial_edu$dic$p.eff, 
              modelo_fh5_spatial_edu$dic$p.eff, modelo_fh2_spatial_edu$dic$p.eff,modelo_fh2_spatial_new_edu$dic$p.eff),
  WAIC    = c(modelo_fh10_spatial_edu$waic$waic, modelo_fh8_spatial_edu$waic$waic, 
              modelo_fh5_spatial_edu$waic$waic, modelo_fh2_spatial_edu$waic$waic,modelo_fh2_spatial_new_edu$waic$waic),
  pWAIC   = c(modelo_fh10_spatial_edu$waic$p.eff, modelo_fh8_spatial_edu$waic$p.eff, 
              modelo_fh5_spatial_edu$waic$p.eff, modelo_fh2_spatial_edu$waic$p.eff,modelo_fh2_spatial_new_edu$waic$p.eff),
  logML   = c(modelo_fh10_spatial_edu$mlik[1,1], modelo_fh8_spatial_edu$mlik[1,1], 
              modelo_fh5_spatial_edu$mlik[1,1], modelo_fh2_spatial_edu$mlik[1,1],modelo_fh2_spatial_new_edu$mlik[1,1])
)
```
...
distritos_sf_predict<-
  edu_censo_final2 %>% 
  mutate(
    fit8_spat = (modelo_fh8_spatial_edu$summary.fitted.values$mean),
    fit10_spat = (modelo_fh10_spatial_edu$summary.fitted.values$mean),
    fit5_spat = (modelo_fh5_spatial_edu$summary.fitted.values$mean),
    fit2_spat = (modelo_fh2_spatial_edu$summary.fitted.values$mean),
    fit2_new = (modelo_fh2_spatial_new_edu$summary.fitted.values$mean),
...
# cross validation ----
```{r}
cpo.10cp.sp <--2*sum(log(modelo_fh10_spatial_edu$cpo$cpo),na.rm = T)
cpo.5cp.sp <--2*sum(log(modelo_fh5_spatial_edu$cpo$cpo),na.rm = T)
cpo.8cp.sp <--2*sum(log(modelo_fh8_spatial_edu$cpo$cpo),na.rm = T)
cpo.2cp.sp <--2*sum(log(modelo_fh2_spatial_edu$cpo$cpo),na.rm = T)
cpo.2cp.sp.new <- -2*sum(log(modelo_fh2_spatial_new_edu$cpo$cpo),na.rm = T)
...
prop_sae_predict_edu %>% 
  ...
  mutate(
    name = factor(name, levels = c("real_cases", "fit10_spat", "fit8_spat", "fit5_spat", 
                                   "fit2_spat", "fit2_new"))
  ) %>% 
...
modelos <- list( # lista para trabajar en bloque
  modelo_fh8_spatial = modelo_fh8_spatial_edu,
  modelo_fh10_spatial = modelo_fh10_spatial_edu,
  modelo_fh5_spatial = modelo_fh5_spatial_edu,
  modelo_fh2_spatial = modelo_fh2_spatial_edu,
  modelo_fh2_new = modelo_fh2_spatial_new_edu
)
```
...
```{r}
resultados_SAE_loreto_edu %>% 
  ggplot(aes(x = edu_estimate, y = ubigeo, col = modelo))+
