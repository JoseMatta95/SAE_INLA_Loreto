# New approach for estimating socioeconomic indicators in small areas with sparse samples and high within-region heterogeneity: an application in the Peruvian Amazon
## Study description
